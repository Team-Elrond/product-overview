...
beforeAll(() =>
  client.query('CREATE TABLE IF NOT EXISTS products (id serial PRIMARY KEY, name VARCHAR(60) NOT NULL, slogan VARCHAR(60) NOT NULL, description VARCHAR(1000) NOT NULL, category VARCHAR(60) NOT NULL, default_price VARCHAR(60) NOT NULL)')
    ...
    .then(() => client.query('CREATE TABLE IF NOT EXISTS styles (style_id serial PRIMARY KEY, product_id serial REFERENCES products (id) ON DELETE CASCADE, name VARCHAR(30) NOT NULL, sale_price VARCHAR(30), original_price VARCHAR(30) NOT NULL, default_style BOOLEAN NOT NULL)'))
    ...
    .then(() => client.query('INSERT INTO photos VALUES (1,1,\'https://images.unsplash.com/photo-1501088430049-71c79fa3283e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80\',\'https://images.unsplash.com/photo-1501088430049-71c79fa3283e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80\'), (2,2,\'https://images.unsplash.com/photo-1534011546717-407bced4d25c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2734&q=80\',\'https://images.unsplash.com/photo-1534011546717-407bced4d25c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80\'), (3,3,\'https://images.unsplash.com/photo-1549831243-a69a0b3d39e0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2775&q=80\',\'https://images.unsplash.com/photo-1549831243-a69a0b3d39e0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80\'), (4,4,\'https://images.unsplash.com/photo-1527522883525-97119bfce82d?ixlib=rb-1.2.1&auto=format&fit=crop&w=668&q=80\',\'https://images.unsplash.com/photo-1527522883525-97119bfce82d?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80\'), (5,5,\'https://images.unsplash.com/photo-1556648202-80e751c133da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80\',\'https://images.unsplash.com/photo-1556648202-80e751c133da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80\'), (6,6,\'https://images.unsplash.com/photo-1532543491484-63e29b3c1f5d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80\',\'https://images.unsplash.com/photo-1532543491484-63e29b3c1f5d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80\') ON CONFLICT (photos_id) DO NOTHING'))
    .then(() => client.query('INSERT INTO sku VALUES (1,1,\'XS\',8), (2,2,\'S\',16), (3,3,\'M\',17), (4,4,\'L\',10), (5,5,\'XL\',15), (6,6,\'XL\',4) ON CONFLICT (sku) DO NOTHING'))
